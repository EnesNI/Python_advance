...
cursor.execute("insert into students (name) value ('Alice')")
cursor.execute("insert into students (name) value ('Bob')")
...
cursor.execute('''
    Select students.name, courses.course_name from students join courses on students_id = courses.student_id
''')
